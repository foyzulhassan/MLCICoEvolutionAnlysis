...
with open('C:\\Users\\dhiarzig\\Documents\\VSCode Projects\\MLCICoEvolutionAnlysis\\RQ3\\data_v2\\most_frequent_command_changes_expanded_v4_all.csv', 'w' , encoding ="utf-8") as f:
    writer = csv.writer(f)
